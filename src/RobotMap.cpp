...
std::shared_ptr<AnalogPotentiometer> RobotMap::shooterPot;
...
void RobotMap::init()
{
	...
	shooterPot.reset(new AnalogPotentiometer(4, 1.0, 0.0));
	lw->AddActuator("ShooterRotation", "Shooter Rotation Encoder", shooterPot);
