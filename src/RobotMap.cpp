...
void RobotMap::init()
{
	...
	drivetrainTalon2.reset(new Talon(15)); //rear left
	lw->AddActuator("Drivetrain", "Rear Left (2)", drivetrainTalon2);

	drivetrainTalon3.reset(new Talon(12)); //front right
	lw->AddActuator("Drivetrain", "Front Right (3)", drivetrainTalon3);

	drivetrainTalon4.reset(new Talon(3)); //rear right
	...
	shooterLeverServo1.reset(new Servo(4));
	...
	shooterLeverDetect.reset(new AnalogInput(6));
