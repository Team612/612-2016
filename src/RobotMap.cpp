...
void RobotMap::init()
{
	...
	/*
	 * Robot Talon values: 0,3,1,2
	 * Kitbot Talon values: 2,3,1,4
	 *
	...
	drivetrainTalon1.reset(new Talon(2)); //front left
	lw->AddActuator("Drivetrain", "Front Left (1)", drivetrainTalon1);

	drivetrainTalon2.reset(new Talon(3)); //rear left
	lw->AddActuator("Drivetrain", "Rear Left (2)", drivetrainTalon2);

	drivetrainTalon3.reset(new Talon(1)); //front right
	...
	shooterRotateMotor.reset(new CANTalon(5));
    ...
    rightFlywheel.reset(new CANTalon(8));
