 ...
 * synchronization because the PIDControl class only calls it in synchronized
...
/**
 * Set the setpoint for the PIDControl
...
/**
 * Returns the change in setpoint over time of the PIDControl
...
/**
 * Stop running the PIDControl, this sets the output to zero before stopping.
 */
...
/**
 * Return true if PIDControl is enabled.
 */
